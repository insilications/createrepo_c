...
Source0  : https://github.com/rpm-software-management/createrepo_c/archive/0.15.0/createrepo_c-0.15.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568069827
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libcreaterepo_c.so.0.15.0
