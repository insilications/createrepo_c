...
Version  : 0.12.1
Release  : 30
URL      : https://github.com/rpm-software-management/createrepo_c/archive/0.12.1.tar.gz
Source0  : https://github.com/rpm-software-management/createrepo_c/archive/0.12.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550708483
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libcreaterepo_c.so.0.12.1
