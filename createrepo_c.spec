...
Source0  : https://github.com/rpm-software-management/createrepo_c/archive/0.11.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530279349
mkdir clr-build
pushd clr-build
...
/usr/lib64/libcreaterepo_c.so.0.11.0
